...
class CommonSetUp(APITestCase):
    ...
    def setUp(self):
        ...
        self.invalid_url_with_id = f'phones/{str(self.invalid_phone_id)}/'


class PhoneDetailIntegrationTest(CommonSetUp):
    def setUp(self):
        super().setUp()
        ...
        self.invalid_payload_update = {'DDD': '99', 'number': '999999999'}
        self.payload_patch = {'DDD': '99'}
    ...
    def test_update_phone_by_id_and_return_status_200_ok(self):
        ...
        self.assertEqual(
            updated_phone.number, self.payload_update.get('number')
        )
        self.assertEqual(
            str(updated_phone.user.id), self.payload_update.get('user')
        )
...
class PhoneCreateIntegrationTest(CommonSetUp):
    def setUp(self):
        super().setUp()
        ...
        self.invalid_payload = {'DDD': '11', 'number': '98754321'}
